...
[divan.ru](https://www.divan.ru) до удаления пустых значений и некорректных ценовых строк, анализа и визуализации.
...
В результате работы получен полный цикл: парсинг → очистка → статистика → визуализация → интерпретация.  
Проект демонстрирует навыки работы с Python, Pandas, визуализацией и структурированием кода.
